                            ...
                            {diseases.map((disease, idx) => (
                                <div key={idx} className="bg-white border rounded-lg p-2.5 shadow-xs relative group flex flex-col gap-1.5">
                                    <button
                                        ...
                                        className="absolute top-2 right-2 text-slate-400 hover:text-red-500 p-0.5 rounded transition-colors"
                                    >
                                    ...
                                    <div className="space-y-1 pr-6">
                                        ...
                                        <Input
                                            ...
                                            className="h-7 text-xs bg-slate-50 border-none font-semibold focus-visible:ring-1 focus-visible:ring-rose-500 placeholder:text-slate-300"
                                            required
                                        />
                                    </div>
                                    <div className="space-y-1">
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => updateDisease(idx, "observations", e.target.value)}
                                            placeholder="Ex: Controlada, toma Losartana..."
                                            className="h-7 text-xs border-slate-100 placeholder:text-slate-300"
                                        />
                                    </div>
                                </div>
                            ))}
                                ...
                                <div key={idx} className="bg-white border rounded-lg p-2.5 shadow-xs relative group flex flex-col gap-1.5">
                                    ...
                                    <div className="space-y-1 pr-6">
                                        ...
                                        <Input
                                            ...
                                            className="h-7 text-xs bg-slate-50 border-none font-semibold focus-visible:ring-1 focus-visible:ring-amber-500 placeholder:text-slate-300"
                                            required
                                        />
                                    </div>
                                    <div className="space-y-1">
                                ...
                                <div key={idx} className="bg-white border rounded-lg p-2.5 shadow-xs relative group flex flex-col gap-1.5">
                                    ...
                                    <div className="space-y-1 pr-6">
                                        ...
                                        <Input
                                            ...
                                            placeholder="Ex: AAS, Glifage, Rivotril..."
                                            className="h-7 text-xs bg-slate-50 border-none font-semibold focus-visible:ring-1 focus-visible:ring-blue-500 placeholder:text-slate-300"
                                            required
                                        />
                                    </div>
                                    <div className="grid grid-cols-2 gap-1.5">
                                        <div className="space-y-0.5">
                                            ...
                                            <Input
                                                ...
                                                placeholder="Ex: 50mg"
                                                className="h-6.5 text-[11px] border-slate-100 px-1.5 placeholder:text-slate-300"
                                            />
                                        </div>
                                        <div className="space-y-0.5">
                                    ...
                                    <div className="space-y-0.5">
                                        ...
                                        <Input
                                            value={med.medicalFollowUp || ""}
                                            onChange={(e) => updateMedication(idx, "medicalFollowUp", e.target.value)}
                                            placeholder="Ex: Cardiologista Dr. Carlos"
                                            className="h-6.5 text-[11px] border-slate-100 placeholder:text-slate-300"
                                        />
                                    </div>
                                </div>
                            ))}
