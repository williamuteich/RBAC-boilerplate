                      ...
                      return (
                        <img
                          ...
                          className={`absolute inset-0 w-full h-full object-cover transition-all duration-1000 ease-in-out ${
                            isActive ? "opacity-100 z-10 animate-ken-burns" : "opacity-0 z-0 scale-95"
                          }`}
                        />
                      );
                    })}
                    {CAROUSEL_PHOTOS[activePhotoIdx]?.label && (
                      <div className="absolute bottom-3 left-1/2 -translate-x-1/2 z-40 max-w-[90%] bg-neutral-950/80 backdrop-blur-md border border-white/10 px-3 py-1 rounded-full shadow-lg text-center pointer-events-none animate-in fade-in flex items-center justify-center gap-1">
