                ...
                <div className="-mx-4 flex flex-wrap justify-center">
                    <div className="w-full px-4 lg:w-5/12">
                        <div className="relative mx-auto max-w-[500px] rounded-2xl bg-white py-14 px-8 shadow-xl sm:p-[60px] border border-stroke">
                            ...
                            <div className="mb-8">
                                <button className="flex cursor-pointer w-full items-center justify-center gap-4 rounded-xl border border-stroke bg-white py-4 px-6 text-base font-semibold text-black shadow-sm duration-300 hover:border-primary hover:bg-gray-50 hover:shadow-md">
