...
export function PublicTributeRenderer({
  ...
  return (
    <div className="min-h-screen w-full flex justify-center items-start font-sans relative overflow-x-hidden select-none bg-[#FAF9FF]">
      {!unlocked && (
        <div className="fixed inset-0 bg-[#0F0D19]/95 flex flex-col items-center justify-center p-6 text-center select-none font-sans z-50 animate-in fade-in duration-300">
          <style jsx global>{`
            @keyframes soft-ping {
